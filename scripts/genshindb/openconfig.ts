...
const createConfigFn = <T extends (...args: any[]) => any>(fn: T, ...patterns: RegExp[]) => {
  (fn as any).test = (s: string, params: number[]) => {
    for (const p of patterns) {
      ...
      if (matched) {
        if (matched.groups) {
          return [paramsIndexOrValue(matched.groups["param"], params), matched.index!, matched[0].length] as const;
        }
        if (isNumber(matched.index)) {
          return [null, matched.index!, matched[0].length] as const;
        }
      }
    }
    return null;
...
const fns: { [k: string]: ReturnType<typeof createConfigFn> } = {
  CharTalent_SangonomiyaKokomi: createConfigFn(
    (v: number) => ({
  ...
  CharTalent_Bennett: createConfigFn(
    (v: number) => ({
  ...
  CharTalent_XinQiu: createConfigFn(
    (v: number) => ({
  ...
  UpElementalBurstHurtOnChargeEfficiency: createConfigFn(
    (v: number) => ({
  ...
  UpAttack: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_ATTACK]: v,
    }),
    /攻击力提[高升](?<param>[.\d]+)点/,
  ),
  UpAttackPercent: createConfigFn(
    (v: number) => ({
  ...
  UpDefencePercent: createConfigFn(
    (v: number) => ({
  ...
  UpShieldCostMinusRatio: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_SHIELD_COST_MINUS_RATIO]: v,
    }),
    /护盾强效提[高升](?<param>[.\d]+%)/,
  ),
  UpHealAdd: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_HEAL_ADD]: v,
    }),
    /治疗加成提[高升](?<param>[.\d]+%)/,
  ),
  UpChargeEfficiency: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_CHARGE_EFFICIENCY]: v,
    }),
    /元素充能效率提升(?<param>[.\d]+%)/,
  ),
  UpHpPercent: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_HP_PERCENT]: v,
    }),
    /生命值提[高升](?<param>[.\d]+%)/,
  ),
  UpElementMastery: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_ELEMENT_MASTERY]: v,
    }),
    /元素精通提[高升](?<param>[.\d]+)点?/,
  ),
  UpAttackAndDefencePercent: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_ATTACK_PERCENT]: v,
      [FightProp.FIGHT_PROP_DEFENSE_PERCENT]: v,
    }),
  ...
  AddElementalHurt: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_FIRE_ADD_HURT]: v,
      [FightProp.FIGHT_PROP_WATER_ADD_HURT]: v,
      [FightProp.FIGHT_PROP_ICE_ADD_HURT]: v,
  ...
  AddHurt_NormalChangedAndPlungingAttack: createConfigFn(
    (v: number) => ({
  ...
  AddHurt_NormalAndChangedAttack: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_NORMAL_ATTACK_ADD_HURT]: v,
      [FightProp.FIGHT_PROP_CHARGED_ATTACK_ADD_HURT]: v,
    }),
  ...
  AddHurt_NormalAttack: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_NORMAL_ATTACK_ADD_HURT]: v,
    }),
    /普通攻击的伤害提[高升](?<param>[.\d]+%)/,
  ...
  AddHurt_ChangedAttack: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_CHARGED_ATTACK_ADD_HURT]: v,
    }),
    /重击造成的伤害提[高升](?<param>[.\d]+%)/,
  ...
  AddHurt_ElementalSkill: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_ELEMENTAL_SKILL_ADD_HURT]: v,
    }),
    /元素战技造成的伤害增加(?<param>[.\d]+%)/,
  ),
  AddHurt_ElementalBurst: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_ELEMENTAL_BURST_ADD_HURT]: v,
    }),
    /元素爆发造成的伤害(至多)?提[高升](?<param>[.\d]+%)/,
  ),
  AddHurt_ElementalSkillAndBurst: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_ELEMENTAL_SKILL_ADD_HURT]: v,
      [FightProp.FIGHT_PROP_ELEMENTAL_BURST_ADD_HURT]: v,
    }),
  ...
  AddHurt_Swirl: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_SWIRL_ADD_HURT]: v,
    }),
    /扩散反应造成的伤害提[高升](?<param>[.\d]+%)/,
  ),
  AddHurt_ElecReactions: createConfigFn(
    (v: number) => ({
  ...
  AddHurt_FireReactions: createConfigFn(
    (v: number) => ({
      [FightProp.FIGHT_PROP_OVERLOADED_ADD_HURT]: v,
    }),
    /超载、燃烧反应造成的伤害提[高升](?<param>[.\d]+%)/,
  ),
  AddHurt_FireReactionRatio: createConfigFn(
    (v: number) => ({

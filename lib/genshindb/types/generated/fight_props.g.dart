...
_$_FightProps _$$_FightPropsFromJson(Map<String, dynamic> json) =>
    _$_FightProps(
      (json['fightProps'] as Map<String, dynamic>).map(
        (k, e) =>
            MapEntry($enumDecode(_$FightPropEnumMap, k), (e as num).toDouble()),
      ),
...
Map<String, dynamic> _$$_FightPropsToJson(_$_FightProps instance) =>
    <String, dynamic>{
      'fightProps':
          instance.fightProps.map((k, e) => MapEntry(_$FightPropEnumMap[k], e)),
      'name': instance.name,
      'from': instance.from,
    };

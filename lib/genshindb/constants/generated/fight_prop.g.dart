...
const _$FightPropLabelMap = {
  ...
  FightProp.NORMAL_ATTACK_EXTRA_HURT: "普攻附伤",
  FightProp.NORMAL_ATTACK_RADIO: "普攻倍率",
  FightProp.NORMAL_ATTACK_ADD_CRITICAL: "普攻加暴",
  FightProp.CHARGED_ATTACK_ADD_HURT: "重击加伤",
  FightProp.CHARGED_ATTACK_RADIO: "重击倍率",
  FightProp.CHARGED_ATTACK_EXTRA_HURT: "重击附伤",
  FightProp.CHARGED_ATTACK_ADD_CRITICAL: "重击加暴",
  FightProp.PLUNGING_ATTACK_ADD_HURT: "下落攻击加伤",
  FightProp.PLUNGING_ATTACK_RADIO: "下落攻击倍率",
  FightProp.PLUNGING_ATTACK_EXTRA_HURT: "下落攻击附伤",
  FightProp.PLUNGING_ATTACK_ADD_CRITICAL: "下落攻击加暴",
  FightProp.ELEMENTAL_SKILL_ADD_HURT: "元素战技加伤",
  FightProp.ELEMENTAL_SKILL_RADIO: "元素战技倍率",
  FightProp.ELEMENTAL_SKILL_EXTRA_HURT: "元素战技附伤",
  FightProp.ELEMENTAL_SKILL_ADD_CRITICAL: "元素战技加暴",
  FightProp.ELEMENTAL_BURST_ADD_HURT: "元素爆发加伤",
  FightProp.ELEMENTAL_BURST_RADIO: "元素爆发倍率",
  FightProp.ELEMENTAL_BURST_EXTRA_HURT: "元素爆发附伤",
  ...
  FightProp.ENEMY_FIRE_SUB_HURT: "怪物火抗",
  FightProp.ENEMY_ELEC_SUB_HURT: "怪物雷抗",
  FightProp.ENEMY_WATER_SUB_HURT: "怪物水抗",
  FightProp.ENEMY_WIND_SUB_HURT: "怪物风抗",
  FightProp.ENEMY_ROCK_SUB_HURT: "怪物岩抗",
  FightProp.ENEMY_GRASS_SUB_HURT: "怪物草抗",
  FightProp.ENEMY_ICE_SUB_HURT: "怪物冰抗",
  FightProp.ENEMY_PHYSICAL_SUB_HURT: "怪物物抗",
  ...
  FightProp.ELEMENTAL_SKILL_EXTRA_HURT__ON__HP: "元素战技附伤(基于最大生命值)",
  FightProp.ELEMENTAL_BURST_EXTRA_HURT__ON__HP: "元素爆发附伤(基于最大生命值)"
};
...
const _$FightPropFormatMap = {
  ...
  FightProp.NORMAL_ATTACK_EXTRA_HURT: "I",
  FightProp.NORMAL_ATTACK_RADIO: "P",
  FightProp.NORMAL_ATTACK_ADD_CRITICAL: "P",
  FightProp.CHARGED_ATTACK_ADD_HURT: "P",
  FightProp.CHARGED_ATTACK_RADIO: "P",
  FightProp.CHARGED_ATTACK_EXTRA_HURT: "I",
  FightProp.CHARGED_ATTACK_ADD_CRITICAL: "P",
  FightProp.PLUNGING_ATTACK_ADD_HURT: "P",
  FightProp.PLUNGING_ATTACK_RADIO: "P",
  FightProp.PLUNGING_ATTACK_EXTRA_HURT: "I",
  FightProp.PLUNGING_ATTACK_ADD_CRITICAL: "P",
  FightProp.ELEMENTAL_SKILL_ADD_HURT: "P",
  FightProp.ELEMENTAL_SKILL_RADIO: "P",
  FightProp.ELEMENTAL_SKILL_EXTRA_HURT: "I",
  FightProp.ELEMENTAL_SKILL_ADD_CRITICAL: "P",
  FightProp.ELEMENTAL_BURST_ADD_HURT: "P",
  FightProp.ELEMENTAL_BURST_RADIO: "P",
  FightProp.ELEMENTAL_BURST_EXTRA_HURT: "I",
  ...
  FightProp.ENEMY_FIRE_SUB_HURT: "P",
  FightProp.ENEMY_ELEC_SUB_HURT: "P",
  FightProp.ENEMY_WATER_SUB_HURT: "P",
  FightProp.ENEMY_WIND_SUB_HURT: "P",
  FightProp.ENEMY_ROCK_SUB_HURT: "P",
  FightProp.ENEMY_GRASS_SUB_HURT: "P",
  FightProp.ENEMY_ICE_SUB_HURT: "P",
  FightProp.ENEMY_PHYSICAL_SUB_HURT: "P",
  ...
  FightProp.ELEMENTAL_SKILL_EXTRA_HURT__ON__HP: "P",
  FightProp.ELEMENTAL_BURST_EXTRA_HURT__ON__HP: "P"
};
